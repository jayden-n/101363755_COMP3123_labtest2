...
const Search = ({
  ...
  return (
    <main className=" flex h-[100vh] w-full items-center justify-center bg-gradient-to-tr from-sky-400 from-20%">
      <section className="flex h-full w-full flex-col items-center justify-center rounded bg-white bg-opacity-20 p-4 text-center text-zinc-700 drop-shadow-lg backdrop-blur-lg md:max-w-[600px] md:px-10 lg:h-[500px] lg:p-24">
        ...
        <div className="relative mt-10 flex md:mt-6">
          <input
            type="text"
            value={term}
